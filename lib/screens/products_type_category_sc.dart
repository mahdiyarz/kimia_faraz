...
import 'products_type_details_sc.dart';

class ProductsTypeCategorySc extends StatelessWidget {
  const ProductsTypeCategorySc({Key? key}) : super(key: key);
