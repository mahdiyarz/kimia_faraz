...
List<Category> categoryData = [
  ...
  Category(
    ...
    name: 'فوم',
    latinName: 'Foam',
    image: 'assets/images/dermalift/cicalift-foam.png',
  ),
  Category(
    id: 6,
    name: 'پن',
    latinName: 'Pain',
    image: 'assets/images/stem_cell/creamy-pan.png',
  ),
  Category(
    id: 7,
    name: 'لوسیون',
...
List<Brands> brandData = [
  ...
  Brands(
    ...
    name: "راکوتن",
    latinName: "Racuten",
    image: "assets/images/racuten/moistrizing.png",
  ),
  Brands(
    id: 5,
    name: "لاکوئینتا",
  ...
  Brands(
    ...
    name: "جوجو",
    latinName: "JOJO",
    image: "assets/images/jojo/new.png",
  ),
  Brands(
    id: 13,
    name: "رینکون",
  ...
  Brands(
    ...
    name: "ساسکین",
    latinName: "Soskin",
    image: "assets/images/soskin/energizing.png",
  )
];
...
//! BioReach Products
  ...
  Products(
    id: 1701,
    name: "سرم روشن کننده و حیات بخش C20%",
    latinName: "C20 hydra glow",
    fullLatinName: "Brightness vitality serum",
    categoryId: 4,
    brandId: 17,
    description: [
      'مناسب برای پوستی که دچار بروز علائم پیری زودرس شده است و فاقد درخشش پوست است.',
      'برای رفع آثار خستگی پوست، درخشان کردن رنگ چهره و کاهش چروک ها و خطوط ریز مورد استفاده قرار می گیرد.',
    ],
    points: [
      '۱۰۰% رنگ پوست یکدست می شود',
      '۹۵% رنگ چهره درخشان تر می شود',
      '۷۵% پوست سفت تر شده و تناژ خود را باز می یابد',
    ],
    activeIngredients: [
      {
        'ingredientName': '۲۰% لیپوزیم های ویتامین C',
        'ingredientInfo':
            'این ترکیب برای عملکرد آنتی اکسیدانی شناخته شده می باشد. ویتامین C تولید کلاژن را ارتقا داده و به کمرنگ کردن رنگدانه های پوستی کمک می کند.',
      },
      {
        'ingredientName': 'گلیسرین گیاهی',
        'ingredientInfo':
            'به تقویت عملکرد سد دفاعی پوست کمک کرده و مرطوب کنندگی بادوامی را برای پوست فراهم می کند.',
      },
    ],
    method:
        'قبل از روتین درمانی صبح و عصر جهت مصرف در نواحی صورت و گردن استفاده شود.',
    image: 'assets/images/soskin/c20.png',
  ),
  Products(
    id: 1702,
    name: 'کرم انرژی زا و مرطوب کننده C10%',
    latinName: 'hydra glow',
    fullLatinName: 'Energizing moisturizing cream',
    categoryId: 1,
    brandId: 17,
    description: [
      'مناسب پوست هایی که اولین نشانه های پیری بر روی آن نمودار شده و فاقد درخشش پوست می باشند.',
      'همچنین باعث کاهش خطوط ریز، ناهماهنگی رنگ چهره و مرطوب کننده عمیق پوست می باشد.',
    ],
    activeIngredients: [
      {
        'ingredientName': 'ویتامین سی بهینه شده',
        'ingredientInfo':
            'برای رفع آثار خستگی پوست، احیای درخشش پوست و کاهش چروک و خطوط ریز پوست.',
      },
      {
        'ingredientName': 'شی باتر',
        'ingredientInfo':
            'مرطوب کننده لیپیدهای پوست بوده و از پوست محافظت می کند.',
      },
      {
        'ingredientName': 'هیالورونیک اسید',
        'ingredientInfo': 'پوست صورت را آبرسانی کرده و سطح پوست را صاف می کند.',
      },
    ],
    method: 'صبح و شب در نواحی صورت و گردن استفاده شود.',
    image: 'assets/images/soskin/energizing.png',
  ),
  Products(
    id: 1703,
    name: 'سرم سه کاره دور چشم (ضد چروک، پف و کبودی)',
    latinName: 'Eye care serum',
    fullLatinName: 'Eye care serum',
    categoryId: 4,
    brandId: 17,
    description: [
      'برای پوست های پرتقالی، دارای مویرگ، رنگدانه ای و دارای علائم پیری مناسب می باشند.',
      'به لطف محرک زیستی ترکیب کافئین و ویتامین C بر روی انواع حلقه های تیره اطراف چشم موثر می باشد.',
    ],
    points: [
      '۸۵% حلقه های تیره اطراف چشم محو می شوند.',
      '۸۰% چروک های اطراف چشم کمتر شده و پوست محکم تر می شود.',
      '۷۵% چروک های پنجه کلاغی اطراف چشم کاهش پیدا می کنند.',
    ],
    activeIngredients: [
      {
        'ingredientName': 'سنتلای آسیایی',
        'ingredientInfo': 'برای بازسازی نواحی حساس اطراف چشم',
      },
      {
        'ingredientName': 'کافئین و ویتامین C',
        'ingredientInfo': 'اکسیژن رسانی به نواحی اطراف چشم',
      },
    ],
    method: 'قبل از روتین درمانی صبح و عصر در نواحی دور چشم استفاده شود.',
    image: 'assets/images/soskin/eye-serum.png',
  ),
  Products(
    id: 1704,
    name: 'کرم ضد آفتاب با SPF50',
    latinName: 'Sun cream',
    fullLatinName: 'Sun cream very high protection SPF50+ RICH',
    categoryId: 1,
    brandId: 17,
    description: [
      'دارای بافت غنی، لطیف و راحت که فاقد سیلیکون و عطرهای آرایشی می باشد.',
      'همچنین بدون ایجاد حس چسبندگی و رگه های سفید بر روی پوست است.',
    ],
    points: [
      '۹۴% زیست سازگار، بدون تاثیر مخرب بر محیط زیست دریایی و صخره های مرجانی می باشد.',
      '۹۸% اشعه ماوراء بنفش به مدت ۵۰۰  دقیقه مسدود می شود.',
      '۱۰۰% از نفوذ طیف های UVA/UVB جلوگیری می شود. از جمله نور آبی',
    ],
    activeIngredients: [
      {
        'ingredientName': 'SPF LOW-TOX',
        'ingredientInfo':
            'فیلتری که با ترکیب ساده خود، سازگار با پوست و محیط زیست می باشد.',
      },
      {
        'ingredientName': 'ویتامین E',
        'ingredientInfo': 'از آسیب های ناشی از استرس اکسیداتیو جلوگیری می کند.',
      },
      {
        'ingredientName': 'آلوئه ورا، پنتانول، عصاره جو دوسر',
        'ingredientInfo':
            'حس آفتاب سوختگی را تسکین داده، پوست را مرطوب و با طراوت می سازد.',
      },
      {
        'ingredientName': 'روغن گل رز مشک',
        'ingredientInfo': 'مغذی برای پوست',
      },
    ],
    color: [
      'بدون رنگ',
    ...
    skinType: 'پوست های حساس',
    method:
        'روزی یک یا دوبار، قبل از قرار گرفتن در معرض تابش نور خورشید استفاده شود.',
    image: 'assets/images/soskin/sunscreen.png',
  ),
  Products(
    id: 1705,
    name: 'ژل شستشوی صورت',
    latinName: 'Gentle purifying cleansing gel',
    fullLatinName: 'Gentle purifying cleansing gel',
    categoryId: 3,
    brandId: 17,
    description: [
      'دارای فرمولاسیون بدون صابون',
      'کارایی ژل پاک کننده سُسکین تنها در یک دوره استفاده ۱۴ روزه، توسط بیش از ۹۵% مصرف کنندگان برای پوست های مختلط و چرب تایید شده است.',
    ],
    points: [
      '۹۰% چربی اضافی پوست را از بین می برد.',
      '۸۵% پوست را پاکیزه و تمیز می کند.',
    ],
    activeIngredients: [
      {
        'ingredientName': 'چای سبز، کالاندولا و رزماری',
        'ingredientInfo':
            'برای مبارزه علیه آکنه، جوش سرسیاه و ظاهر ناخوشایند جای جوش.',
      },
      {
        'ingredientName': 'روغن بسیار مفید برگ درخت چای',
        'ingredientInfo': 'باعث تنظیم چربی اضافی پوست می شود.',
      },
      {
        'ingredientName': 'عصاره خیار',
        'ingredientInfo': 'مرطوب کننده قوی و غنی از ویتامین ها و عناصر معدنی',
      },
    ],
    skinType: 'پوست های چرب و مختلط',
    method: 'صبح و عصر بر روی پوست مرطوب استفاده شود.',
    image: 'assets/images/soskin/cleansing-gel.png',
  ),
  Products(
    id: 1706,
    name: 'آبرسان پوست چرب',
    latinName: 'Hydra',
    fullLatinName: 'Ultra-comfort compensating care',
    categoryId: 1,
    brandId: 17,
    description: [
      'تسکین دهنده احساسات ناخوشایند در پوست بوده و عملکرد سد دفاعی پوست را بهبود می بخشد.',
      'همچنین ضد جوش های سر سیاه نیز می باشد.',
    ],
    points: [
      '۱۰۰% پوست نرم تر شده و حس سفتی و زمختی نخواهد داشت.',
      '۹۵% رطوبت رسان و تقویت کننده سد دفاعی پوست می باشد.',
      '۹۵% کاهش دهنده قرمزی پوست می باشد.',
    ],
    activeIngredients: [
      {
        'ingredientName': 'اسید گلیسیریتینیک',
        'ingredientInfo':
            'قرمزی و عوارض جانبی مرتبط با خشکی پوست را کاهش می دهد.',
      },
      {
        'ingredientName': 'دی پنتانول',
        'ingredientInfo': 'برای حفظ عملکرد سد دفاعی پوست مناسب است.',
      },
    ],
    skinType: 'پوست های مستعد آکنه و آسیب دیده',
    method: 'صبح و عصر در نواحی صورت استفاده شود.',
    image: 'assets/images/soskin/hydra.png',
  ),
  Products(
    id: 1707,
    name: 'کرم ضدلک',
    latinName: 'Clarifying cream',
    fullLatinName: 'Clarifying cream',
    categoryId: 1,
    brandId: 17,
    description: [
      'مناسب پوست فاقد درخشندگی و پوستی که دچار تجمع رنگدانه شده است.',
      'استحکام پوست را افزایش داده و رنگ چهره را یکدست می کند. لک های تیره را از بین برده و پوست را در طول شب بازسازی می کند.',
      'تاثیر گذاری این محصول از روز پانزدهم استفاده مداوم مشهود خواهد بود.',
    ],
    points: [
      '۸۱% تضعیف چروک های پوست از روز پانزدهم استفاده',
      '۶۰% از روز پانزدهم استفاده، رنگ چهره روشن تر و درخشان تر می شود.',
    ],
    activeIngredients: [
      {
        'ingredientName': 'نیاسین آمید، هگزیل رسورسینول و آلفا آربوتین',
        'ingredientInfo':
            'تجمع رنگدانه ها را مورد هدف قرار می دهد و بدین ترتیب به کمرنگ کردن لک های قابل مشاهده پوست کمک کرده و از ظهور لک های جدید جلوگیری می کند.',
      },
      {
        'ingredientName': 'شی باتر',
        'ingredientInfo':
            'مغذی لیپیدهای پوست بوده و بطور موثر آن ها را مرطوب می کند. سبب ترمیم سد دفاعی پوست شده و آن را از پیری محافظت می کند.',
      },
    ],
    method:
        'عصر در نواحی صورت، گردن و قفسه سینه استفاده شود. استفاده برای خانم های باردار و شیرده ممنوع می باشد مگر با تجویز پزشک.',
    image: 'assets/images/soskin/clarifying-cream.png',
  ),
  Products(
    id: 1708,
    name: 'سرم ضدلک و روشن کننده',
    latinName: 'Intense Clarifying serum',
    fullLatinName: 'Intense Clarifying serum',
    categoryId: 4,
    brandId: 17,
    description: [
      'مناسب پوست فاقد درخشندگی و پوستی که دچار تجمع رنگدانه شده است.',
      'لک های تیره صورت را از بین برده و رنگ چهره را یکدست می کند.',
    ],
    activeIngredients: [
      {
        'ingredientName': 'نیاسین آمید، هگزیل رسورسینول و آلفا آربوتین',
      ...
      },
      {
        'ingredientName': 'لاکتیک اسید',
        'ingredientInfo':
            'مسئول لایه برداری ملایم و اصلاح سریع رنگ چهره می باشد.',
      },
    ],
    method:
        'قبل از روتین درمانی صبح و عصر در نواحی صورت، گردن و قفسه سینه استفاده شود. همچنین از کرم ضد آفتاب مناسب استفاده شود. استفاده از این محصول برای خانم های باردار و شیرده ممنوع می باشد مگر با تجویز پزشک.',
    image: 'assets/images/soskin/clarifying-serum.png',
  ),
];
